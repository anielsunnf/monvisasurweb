...
export function LanguageSwitcher() {
  ...
  return <div className="lang-switcher">
    <button type="button" className="btn btn-ghost lang-btn" onClick={() => setOpen(value => !value)} aria-label={t('common.language')} aria-expanded={open}>{current.flag} {current.label} ▾</button>
