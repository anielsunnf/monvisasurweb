...
- **Contrastes des deux thèmes** : le mode clair et le mode sombre garantissent la lisibilité des pastilles de statut, chips, messages d'erreur et accents sur toutes les pages, y compris sur téléphone.
